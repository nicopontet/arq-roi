...
public class ExternalOperationsHandler {
    ...
    public static List<ServiceOperationDTO> getOperations(){
        Response response = callOperationKremlin("","get","");
    ...
    public static Response callOperationKremlin(String operation,String method,String body){
     ...
     public static Response callOperation(String uri,String method,String body){
        Response response = null;
        if(method.toLowerCase().equals("get")){
            response = getOperation(uri);
        }else if(method.toLowerCase().equals("post")){
